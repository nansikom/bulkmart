...
import {View, Text, FlatList, StyleSheet, Button,Pressable, Image, Touchable, TouchableOpacity} from 'react-native';
...
export default function CheckoutScreen() {
    ...
    return (
        <View style ={styles.container}>
            ...
            <TouchableOpacity style={[styles.smallbutton]} onPress={handleConfirmPurchase}>
                <Text style={styles.buttonText}>Confirm Purchase</Text>
            </TouchableOpacity>
            
            <TouchableOpacity style={styles.smallbutton} onPress={() => router.push('/screens/payementscreen')} >
...
const styles =  StyleSheet.create({
    ...
    buttonText:{
     ...
     infContainer: {
        ...
        justifyContent:'space-between', //side by side
        marginBottom:30
    },
